...
class UpdateM extends React.Component{
    constructor(){
        super();
        this.state={
            Nom:'',
    ...
    fetchData(){
        ...
        .then((data)=>{
            this.setState({
                Nom:data.Nom,
                Coef:data.Coef,
                Total_Heures_Cm:data.Total_Heures_Cm,
                Total_Heures_Td:data.Total_Heures_Td
            });
        });
    }
        ...
        return (
            <table className="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        <td colSpan="2">
                            <Link to={'/Matiere'} className="btn btn-dark"type="submit" onClick={this.submitForm}> Update </Link>
                        </td>
                    </tr>
                </tbody>
            </table>
